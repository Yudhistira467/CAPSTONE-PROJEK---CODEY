...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonSignup,
      @NonNull ConstraintLayout main, @NonNull EditText signupEmail,
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ConstraintLayout) rootView, buttonSignup, main,
          signupEmail, signupPassword, signupRedirect, signupUsername);
    }
