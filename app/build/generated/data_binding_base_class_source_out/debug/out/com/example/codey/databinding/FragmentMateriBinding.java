...
public final class FragmentMateriBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rcMateri;

  private FragmentMateriBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView rcMateri) {
    this.rootView = rootView;
    this.rcMateri = rcMateri;
  }
  ...
  public static FragmentMateriBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rc_materi;
      RecyclerView rcMateri = ViewBindings.findChildViewById(rootView, id);
      if (rcMateri == null) {
        break missingId;
      }

      return new FragmentMateriBinding((FrameLayout) rootView, rcMateri);
    }
